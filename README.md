...
[![Daha önce tecrübe etmiş olduklarım](https://skillicons.dev/icons?i=py,cs,vscode,androidstudio,unity,linux,bash,github,wordpress,html,css,notion)](https://skillicons.dev)
...
[![Öğrenmeye can attıklarım](https://skillicons.dev/icons?i=react,js,swift,kotlin,androidstudio,unity,unreal)](https://skillicons.dev)
